...
export default function MeetTheBand({tienaImages, sophiaImages, mirandaImages}){
      ...
      <div className="meet-the-band-wrapper">
          <div className="band-members">
              ...
              <div className="band-pictures">
                  <Image className="full-band" src={fullGroup}  alt=""/>
                  <Image className="band-image sophia" src={sophia} style={{opacity: selectedMember === 1 ? 1 : 0}} alt=""/>
                  <Image className="band-image tiena" src={tiena} style={{opacity: selectedMember === 0 ? 1 : 0}} alt=""/>
                  <Image className="band-image miranda" src={miranda} style={{opacity: selectedMember === 2 ? 1 : 0}} alt=""/>
