    ...
    return(
        <div className="album-links-container">
            ...
            <div className="album-links">
                <Image className="album-link" src={linkIcons[0]} alt='' title={"Spotify"} onClick={() => handleClick(links[0])} width="auto" height="auto"/>
                <Image className="album-link" src={linkIcons[1]} alt='' title={"Apple Music"} onClick={() => handleClick(links[1])} width="auto" height="auto"/>
                <Image className="album-link" src={linkIcons[2]} alt='' title={"SoundCloud"} onClick={() => handleClick(links[2])} width="auto" height="auto"/>
                <Image className="album-link" src={linkIcons[3]} alt='' title={"BandCamp"} onClick={() => handleClick(links[3])} width="auto" height="auto"/>
                <Image className="album-link" src={linkIcons[4]} alt='' title={"Youtube"} onClick={() => handleClick(links[4])} width="auto" height="auto"/>
            </div>
        </div>
    );
}
